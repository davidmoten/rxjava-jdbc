...
final class PreparedStatementBatchingRecorder implements PreparedStatement {

    private final PreparedStatement ps;
    private final BatchListener listener;

    public PreparedStatementBatchingRecorder(PreparedStatement ps, BatchListener listener) {
        Preconditions.checkNotNull(listener);
        this.ps = ps;
        this.listener = listener;
    }

    static interface BatchListener {
        void postAddBatch();

        void postExecuteBatch();
    ...
    public void clearBatch() throws SQLException {
        ps.clearBatch();
        listener.postClearBatch();
    }

    @Override
    public int[] executeBatch() throws SQLException {
        int[] result = ps.executeBatch();
        listener.postExecuteBatch();
        return result;
    }
