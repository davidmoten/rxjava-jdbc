 ...
 */
public class QueryUpdateFromObservableOperator implements Operator<Integer, List<Object>> {
     ...
     * @param operatorType
     */
    QueryUpdateFromObservableOperator(final QueryUpdate.Builder builder) {
