...
final class ConnectionBatch implements Connection {
    ...
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        return wrap(con.prepareStatement(sql), sql, Statement.NO_GENERATED_KEYS);
    }
    ...
    public PreparedStatement prepareStatement(String sql, int resultSetType,
        ...
        return wrap(con.prepareStatement(sql, resultSetType, resultSetConcurrency), sql, Statement.NO_GENERATED_KEYS);
    }
    ...
    public PreparedStatement prepareStatement(String sql, int resultSetType,
        ...
        return wrap(con.prepareStatement(sql, resultSetType, resultSetConcurrency,
                resultSetHoldability), sql, Statement.NO_GENERATED_KEYS);
    }
    ...
    public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys)
            throws SQLException {
        return wrap(con.prepareStatement(sql, autoGeneratedKeys), sql, autoGeneratedKeys);
    }
    ...
    public PreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
        return wrap(con.prepareStatement(sql, columnIndexes), sql, Statement.NO_GENERATED_KEYS);
    }

    @Override
    public PreparedStatement prepareStatement(String sql, String[] columnNames)
            throws SQLException {
        return wrap(con.prepareStatement(sql, columnNames), sql, Statement.NO_GENERATED_KEYS);
    }
